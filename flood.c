 ...
 *
 * @returns A data structure containing the parsed values.
 */
...
/**
 * Sets the source MAC address of an Ethernet frame.
 *
 * @param ether_frame The Ethernet frame to modify.
 * @param source_mac The source MAC address to set.
 *
 * @returns None
 */
...
/**
 * Sets the destination MAC address in an Ethernet frame.
 *
 * @param frame The Ethernet frame to modify.
 * @param mac_address The MAC address to set as the destination.
 *
 * @returns None
 */
...
/**
 * Sets the Ethernet type field in a network packet.
 *
 * @param ether_type The Ethernet type value to set.
 *
 * @returns None
 */
...
/**
 * Randomizes the IP address of a device.
 *
 * @returns The randomized IP address.
 */
...
/**
 * Randomizes the IP address of a given computer.
 *
 * @param None
 *
 * @returns None
